 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@primus/primeuix/styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@primus/primeuix/styled` instead.
