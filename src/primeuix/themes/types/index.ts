 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@selisedev/primus-beta/primeuix/styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@selisedev/primus-beta/primeuix/styled` instead.
