...
import type { MultiSelectBlurEvent, MultiSelectChangeEvent, MultiSelectFilterEvent, MultiSelectFocusEvent } from '@selisedev/primus-beta/core/types/multiselect';
interface City {
    name: string;
    code: string;
    country?: string;
