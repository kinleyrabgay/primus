...
describe('Splitter', () => {
    ...
    describe('Mouse Resize Operations', () => {
        it.skip('should start resize on mouse down', () => {
            ...
            vi.spyOn(splitterInstance, 'resizeStart').mockImplementation(() => undefined);
    ...
    describe('Touch Resize Operations', () => {
        it.skip('should handle touch start', () => {
            ...
            vi.spyOn(splitterInstance, 'onGutterTouchStart').mockImplementation(() => undefined);
        ...
        it.skip('should handle touch move', () => {
            ...
            vi.spyOn(splitterInstance, 'onGutterTouchMove').mockImplementation(() => undefined);
        ...
        it.skip('should handle touch end', () => {
            ...
            vi.spyOn(splitterInstance, 'onGutterTouchEnd').mockImplementation(() => undefined);
    ...
    describe('Keyboard Navigation', () => {
        ...
        describe('Horizontal Layout', () => {
            ...
            it.skip('should handle left arrow key', async () => {
                ...
                vi.spyOn(splitterInstance, 'setTimer').mockImplementation(() => undefined);
        ...
        it.skip('should clear timer on key up', () => {
            ...
            vi.spyOn(splitterInstance, 'clearTimer').mockImplementation(() => undefined);
            vi.spyOn(splitterInstance, 'resizeEnd').mockImplementation(() => undefined);
