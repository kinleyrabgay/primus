...
describe('Listbox', () => {
    ...
    describe('Options and Data Binding', () => {
        ...
        it('should handle option selection', async () => {
            vi.spyOn(testComponent, 'onSelectionChange').mockImplementation(() => undefined);
    ...
    describe('Double Click Events', () => {
        ...
        it('should emit onDblClick event', async () => {
            const listboxComponent = testFixture.debugElement.query(By.css('p-listbox')).componentInstance;
            vi.spyOn(listboxComponent.onDblClick, 'emit').mockImplementation(() => undefined);
    ...
    describe('All Output Event Emitters', () => {
        ...
        it('should emit onFocus event', async () => {
            vi.spyOn(testComponent, 'onFocus').mockImplementation(() => undefined);
        ...
        it('should emit onBlur event', async () => {
            vi.spyOn(testComponent, 'onBlur').mockImplementation(() => undefined);
        ...
        it('should emit onFilter event', async () => {
            ...
            testFixture.changeDetectorRef.markForCheck();
            await testFixture.whenStable();
            vi.spyOn(testComponent, 'onFilter').mockImplementation(() => undefined);
        ...
        it('should emit onDblClick event', async () => {
            vi.spyOn(testComponent, 'onDblClick').mockImplementation(() => undefined);
...
describe('Listbox ViewChild and Advanced Scenarios', () => {
    ...
    describe('All Event Emitters Comprehensive Test', () => {
        it('should emit all events with proper data', async () => {
            vi.spyOn(component, 'onChangeHandler').mockImplementation(() => undefined);
            vi.spyOn(component, 'onFilterHandler').mockImplementation(() => undefined);
            vi.spyOn(component, 'onFocusHandler').mockImplementation(() => undefined);
            vi.spyOn(component, 'onBlurHandler').mockImplementation(() => undefined);
            vi.spyOn(component, 'onDblClickHandler').mockImplementation(() => undefined);
