...
import { BlockableUI, Footer, Header, PrimeTemplate, SharedModule } from '@selisedev/primus-beta/core/api';
...
import { CardPassThrough } from '@selisedev/primus-beta/core/types/card';
