...
import { AutoCompleteCompleteEvent, AutoCompleteDropdownClickEvent, AutoCompleteSelectEvent, AutoCompleteUnselectEvent } from '@selisedev/primus-beta/core/types/autocomplete';
...
@Component({
    standalone: true,
    imports: [AutoCompleteModule, SharedModule, FormsModule, ReactiveFormsModule, CommonModule],
...
describe('AutoComplete', () => {
    ...
    describe('Complex Situations and Edge Cases', () => {
        ...
        it('should handle rapid input changes with debouncing', async () => {
            vi.spyOn(testComponent, 'onSearch').mockImplementation(() => undefined);
