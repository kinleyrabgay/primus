...
import { blockBodyScroll, unblockBodyScroll } from '@selisedev/primus-beta/primeuix/utils';
...
import { BlockUIPassThrough } from '@selisedev/primus-beta/core/types/blockui';
